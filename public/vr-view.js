...
window.addEventListener('pagehide',()=>{disposed=true;stream?.close();clearInterval(watch);cancelAnimationFrame(raf);resize.disconnect();vr.destroy();planner.destroy();},{once:true});

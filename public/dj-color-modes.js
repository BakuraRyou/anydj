...
export const COLOR_MODES=[
 {id:'auto',name:'Songanalyse',category:'Automatisch',colors:[]},
...
export function applyTrackColors(plan,mode){
 if(!validColorMode(mode))return plan;
 ...
 return choreographColors({...plan,frames,choreographyBaseFrames:frames,colorPalette:palette,colorEvents:[],effectiveOptions:{...plan.effectiveOptions,palette:'custom'}},plan.showProfile||'auto');
}

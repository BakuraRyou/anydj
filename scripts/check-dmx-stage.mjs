...
try {
  ...
  await writeFile(new URL('../reports/dmx-stage-mobile.png',import.meta.url),Buffer.from((await c('Page.captureScreenshot',{format:'png'})).data,'base64'));
  ...
  console.log('DMX browser checks passed: demo, blackout, stop, live frame, mobile bounds, keyboard, no hardware session.');
} finally {

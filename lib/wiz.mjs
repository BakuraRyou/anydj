/**
 * Small, independent implementation of the unencrypted local WiZ UDP protocol.
...
export function udpRequest(ip, method, params = {}, {
  ...
  return new Promise((resolve, reject) => {
    ...
    timers.push(setTimeout(() => finish(new AppError(
      `Keine UDP-Antwort von ${ip} auf ${method}. WLAN, IP, Firewall und lokale WiZ-Freigabe prüfen.` +

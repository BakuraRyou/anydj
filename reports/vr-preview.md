...
Bei verbundenem Empfänger werden bis zu 20 Schnappschüsse pro Sekunde gesendet; ohne Empfänger etwa zwei. Es gibt höchstens eine laufende Upload-Anfrage. Bewegte Ziele und Helligkeit werden im Empfänger kurz interpoliert. SSE stellt bei Wiederverbindung den neuesten vollständigen Stand zu, statt alte Bewegungen abzuarbeiten. Bei länger als drei Sekunden ausbleibenden Daten zeigt die Seite den Verbindungsverlust und dunkelt die veralteten Lichtzustände ab. Ein Serverneustart oder Ablauf erfordert einen neuen Link; kurze Netzunterbrechungen überbrückt die Seite automatisch.
